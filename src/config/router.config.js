...
export const asyncRouterMap = [
  {
    ...
    children: [
     ...
     
      {
        ...
        name: 'platformPage',
        component: RouteView,
        meta: { title: '平台管理', icon: 'slack', permission: ['dashboard'] },
        redirect: '/platform/statistics',
        children: [
          {
            path: '/platform/statistics',
            name: 'TestIconSelect',
            component: () => import('@/views/platform/statistics'),
            meta: { title: '平台使用情况总览', keepAlive: true, permission: ['dashboard'] }
          }, {
            path: '/platform/loginlist',
            name: 'loginlist',
            component: () => import('@/views/platform/loginlist'),
            meta: { title: '登录记录', keepAlive: true }
          }, {
            path: '/platform/searchlist',
            name: 'Searchlist',
            component: () => import('@/views/platform/searchlist'),
            meta: { title: '筛选记录', keepAlive: true }
          }, {
            path: '/platform/exportlist',
            name: 'Exportlist',
            component: () => import('@/views/platform/exportlist'),
            meta: { title: '导出记录', keepAlive: true }
          }, {
            path: '/platform/approval',
            name: 'Approval',
            component: () => import('@/views/platform/approval'),
            meta: { title: '审批记录', keepAlive: true }
          }, {
            path: '/platform/projectlist',
            name: 'Projectlist',
            component: () => import('@/views/platform/projectlist'),
            meta: { title: '项目情况', keepAlive: true }
          },
          // {
          //   path: '/platform/user-list',
          //   name: 'UserList',
          //   component: () => import('@/views/platform/UserList'),
          //   meta: { title: '帐号管理', keepAlive: true }
          // }, {
          //   path: '/platform/permission-list',
          //   name: 'PermissionList',
          //   component: () => import('@/views/platform/PermissionList'),
